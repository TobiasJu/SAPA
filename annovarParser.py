...
class AnnovarParser:
    ...
    def __init__(self, Chr, Start, End, Ref, Alt, Func_refGene, Gene_refGene, GeneDetail_refGene, ExonicFunc_refGene,
        ...
        self.__SIFT_score = (SIFT_score, self.__SIFT_min, self.__SIFT_max)  # (value, min, max)
        self.__SIFT_pred = SIFT_pred
        self.__Polyphen2_HDIV_score = (Polyphen2_HDIV_score, self.__Polyphen2_HDIV_min, self.__Polyphen2_HDIV_max)
        self.__Polyphen2_HDIV_pred = Polyphen2_HDIV_pred
        self.__Polyphen2_HVAR_score = (Polyphen2_HVAR_score, self.__Polyphen2_HVAR_min, self.__Polyphen2_HVAR_max)
        self.__Polyphen2_HVAR_pred = Polyphen2_HVAR_pred
        self.__LRT_score = (LRT_score, self.__LRT_min, self.__LRT_max)
        self.__LRT_pred = LRT_pred
        self.__MutationTaster_score = (MutationTaster_score, self.__MutationTaster_min, self.__MutationTaster_max)
        self.__MutationTaster_pred = MutationTaster_pred
        self.__MutationAssessor_score = (MutationAssessor_score, self.__MutationAssessor_min, self.__MutationAssessor_max)
        self.__MutationAssessor_pred = MutationAssessor_pred
        self.__FATHMM_score = (FATHMM_score, self.__FATHMM_min, self.__FATHMM_max)
        self.__FATHMM_pred = FATHMM_pred
        self.__PROVEAN_score = (PROVEAN_score, self.__PROVEAN_min, self.__PROVEAN_max)
        ...
        self.__CADD_phred = (CADD_phred, self.__CADD_phred_min, self.__CADD_phred_max)
        self.__DANN_score = (DANN_score, self.__DANN_min, self.__DANN_max)
        self.__fathmm_MKL_coding_score = (fathmm_MKL_coding_score, self.__fathmm_MKL_coding_min, self.__fathmm_MKL_coding_max)
        self.__fathmm_MKL_coding_pred = fathmm_MKL_coding_pred
        self.__MetaSVM_score = (MetaSVM_score, self.__MetaSVM_min, self.__MetaSVM_max)
        self.__MetaSVM_pred = MetaSVM_pred
        self.__MetaLR_score = (MetaLR_score, self.__MetaLR_min, self.__MetaLR_max)
